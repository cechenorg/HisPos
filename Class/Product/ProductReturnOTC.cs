...
{
    public class ProductReturnOTC : AbstractClass.Product, IProductReturn, ITrade, IDeletable, INotifyPropertyChanged, ICloneable
    {
        private ProductReturnOTC() { }
        ...
        public object Clone()
        {
            ProductReturnOTC otc = new ProductReturnOTC();
