    ...
    public class PrescriptionSearchViewModel : TabBase
    {
        ...
        private void SearchAction()
        {
            ...
            worker.DoWork += (o, ea) =>
            {
                ...
                //依條件查詢對應處方
                previews.GetSearchPrescriptions(StartDate, EndDate, PatientName.Trim(),PatientIDNumber.Trim(), PatientBirth, SelectedAdjustCase,MedicineID.Trim(), MedicineName.Trim(), SelectedInstitution);
