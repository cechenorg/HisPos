...
using MessageType = His_Pos.Class.MessageType;
...
using ErrorCode = His_Pos.Class.ErrorCode;
...
{
    public class OfflineAdjustViewModel:TabBase
    {
        #region Variables
        ...
        #endregion
        public OfflineAdjustViewModel()
        {
            Initial();
        }
        ~OfflineAdjustViewModel()
        {
