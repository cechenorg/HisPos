...
namespace His_Pos.NewClass.Product.Medicine.MedBag
{
    public class MedBagMedicine
    {
        ...
        public MedBagMedicine(MedicineRefactoring.MedicineNHI m, bool isSingle)
        {
            Id = m.ID;
            if (isSingle)
            {
        ...
        public MedBagMedicine(MedicineRefactoring.MedicineOTC m, bool isSingle)
        {
            Id = m.ID;
            if (isSingle)
            {
        ...
        public MedBagMedicine(MedicineRefactoring.MedicineSpecialMaterial m, bool isSingle)
        {
            Id = m.ID;
            if (isSingle)
            {
