...
namespace His_Pos.HisApi
{
    ...
    {
        // 1.1 讀取不需個人PIN碼資料
        [DllImport("C:\\Windows\\SysWOW64\\C:\\Windows\\SysWOW64\\CSHIS.dll", EntryPoint = "hisGetBasicData")]
        public static extern int hisGetBasicData(byte[] pBuffer, ref int iBufferLen);
        // 1.2 掛號或報到時讀取基本資料
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll", EntryPoint = "hisGetRegisterBasic")]
        public static extern int hisGetRegisterBasic(byte[] pBuffer, ref int iBufferLen);
        // 1.3 預防保健掛號作業
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll", EntryPoint = "hisGetRegisterPrevent")]
        public static extern int hisGetRegisterPrevent(byte[] pBuffer, ref int intpBufferLen);
        // 1.4 孕婦產前檢查掛號作業
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll", EntryPoint = "hisGetRegisterPregnant")]
        public static extern int hisGetRegisterPregnant(byte[] pBuffer, ref int iBufferLen);
        // 1.5 讀取就醫資料不需HPC卡的部份
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll", EntryPoint = "hisGetTreatmentNoNeedHPC")]
        public static extern int hisGetTreatmentNoNeedHPC(byte[] strpBuffer, ref int intpBufferLen);
        // 1.6 讀取就醫累計資料
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll", EntryPoint = "hisGetCumulativeData")]
        public static extern int hisGetCumulativeData(byte[] pBuffer, ref int iBufferLen);
        // 1.7 讀取醫療費用線累計
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetCumulativeFee")]
        public static extern int hisGetCumulativeFee(byte[] strpBuffer, ref int intpBufferLen);
        // 1.8 讀取就醫資料需HPC卡的部份
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetTreatmentNeedHPC")]
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetSeqNumber")]
        public static extern int hisGetSeqNumber(byte[] cTreatItem, byte[] cBabyTreat, byte[] strpBuffer, ref int intpBufferLen);
        // 1.10 讀取處方箋作業
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisReadPrescription")]
        ...
        // 1.11 讀取預防接種資料
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetInoculateData")]
        public static extern int hisGetInoculateData(byte[] strpBuffer, ref int intpBufferLen);
        // 1.12 讀取器官捐贈資料
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetOrganDonate")]
        public static extern int hisGetOrganDonate(byte[] pBuffer, ref int iBufferLen);
        // 1.13 讀取緊急聯絡電話資料
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "HisGetEmergentTel")]
        public static extern int HisGetEmergentTel(byte[] pBuffer, ref int iBufferLen);
        // 1.14 讀取最近一次就醫序號
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetLastSeqNum")]
        public static extern int hisGetLastSeqNum(byte[] pBuffer, ref int iBufferLen);
        // 1.15 讀取卡片狀態
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetCardStatus")]
        public static extern int hisGetCardStatus(int CardType);
        // 1.16 就醫診療資料寫入作業
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteTreatmentCode")]
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteOrganDonate")]
        public static extern int hisWriteOrganDonate(byte[] pPatientID, byte[] pPatientBirthDate, byte[] pOrganDonate);
        // 1.22 預防保健資料寫入作業
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteHealthInsurance")]
        ...
        // 1.23 緊急聯絡電話資料寫入作業
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteEmergentTel")]
        public static extern int hisWriteEmergentTel(byte[] pPatientID, byte[] pPatientBirthDate, byte[] pEmergentTel);
        // 1.24 寫入產前檢查資料
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWritePredeliveryCheckup")]
        public static extern int hisWritePredeliveryCheckup(byte[] pPatientID, byte[] pPatientBirthDate, byte[] pCheckupCode);
        // 1.25 清除產前檢查資料
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisDeletePredeliveryData")]
        public static extern int hisDeletePredeliveryData(byte[] pPatientID, byte[] pPatientBirthDate);
        // 1.26 預防接種資料寫入作業
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteInoculateData")]
        public static extern int hisWriteInoculateData(byte[] pPatientID, byte[] pPatientBirthDate, byte[] pItem, byte[] pPackageNumber);
        // 1.27 驗證健保IC卡之PIN值
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csVerifyHCPIN")]
        public static extern int csVerifyHCPIN();
        // 1.28 輸入新的健保IC卡PIN值
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csInputHCPIN")]
        public static extern int csInputHCPIN();
        // 1.29 停用健保IC卡之PIN碼輸入功能
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csDisableHCPIN")]
        public static extern int csDisableHCPIN();
        // 1.30 健保IC卡卡片內容更新作業
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csUpdateHCContents")]
        public static extern int csUpdateHCContents();
        // 1.31 開啟讀卡機連結埠
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csOpenCom")]
        public static extern int csOpenCom(int pcom);
        // 1.32 關閉讀卡機連結埠
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csCloseCom")]
        public static extern int csCloseCom();
        // 1.33 讀取重大傷病註記資料
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetCriticalIllness")]
        public static extern int hisGetCriticalIllness(byte[] pBuffer, ref int iBufferLen);
        // 1.34 讀取讀卡機日期時間
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csGetDateTime")]
        public static extern int csGetDateTime(byte[] pBuffer, ref int iBufferLen);
        //1.35 讀取卡片號碼
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csGetCardNo")]
        public static extern int csGetCardNo(int CardType, byte[] pBuffer, ref int iBufferLen);
        //1.36 檢查健保IC卡是否設定密碼
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csISSetPIN")]
        public static extern int csISSetPIN();
        //1.37 取得就醫序號新版
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetSeqNumber256")]
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetRegisterBasic2")]
        //1.38 掛號或報到時讀取有效卡期限及就醫次數資料
        public static extern int hisGetRegisterBasic2(byte[] pBuffer, ref int iBufferLen);
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csUnGetSeqNumber")]
        //1.39 回復就醫資料累計值---退掛
        public static extern int csUnGetSeqNumber(byte[] pUnTreatDate);
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csUpdateHCNoReset")]
        //1.40 健保IC卡卡片內容更新作業
        public static extern int csUpdateHCNoReset();
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisReadPrescriptMain")]
        //1.41 讀取就醫資料-門診處方箋
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisReadPrescriptLongTerm")]
        //1.42 讀取就醫資料-長期處方箋
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisReadPrescriptHVE")]
        //1.43 讀取就醫資料-重要醫令
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisReadPrescriptAllergic")]
        //1.44 讀取就醫資料-過敏藥物
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteMultiPrescript")]
        //1.45 多筆處方箋寫入作業 
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteAllergicNum")]
        //1.46 過敏藥物寫入指定欄位作業
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteTreatmentData")]
        //1.47 就醫診療資料及費用寫入作業
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWritePrescriptionSign")]
        //1.48 處方箋寫入作業-回傳簽章
        ...
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisWriteMultiPrescriptSign")]
        //1.49 多筆處方箋寫入作業-回傳簽章
        ...
        // 3.2 資料上傳 增加「處方筆數」參數 
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "csDownloadData")]
        ...
        // 4.1 取得醫事人員卡狀態
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hpcGetHPCStatus")]
        public static extern int hpcGetHPCStatus(int Req, ref int Status);
        // 4.2 檢查醫事人員卡之PIN值
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hpcVerifyHPCPIN")]
        public static extern int hpcVerifyHPCPIN();
        // 4.3 輸入新的醫事人員卡之PIN值
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hpcInputHPCPIN")]
        public static extern int hpcInputHPCPIN();
        // 4.4 解開鎖住的醫事人員卡
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hpcUnlockHPC")]
        public static extern int hpcUnlockHPC();
        // 4.5 取得醫事人員卡序號
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hpcGetHPCSN")]
        public static extern int hpcGetHPCSN(byte[] pBuffer, ref int iBufferLen);
        // 4.6 取得醫事人員卡身份證字號
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hpcGetHPCSSN")]
        public static extern int hpcGetHPCSSN(byte[] pBuffer, ref int iBufferLen);
        // 4.7 取得醫事人員卡中文姓名
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hpcGetHPCCNAME")]
        public static extern int hpcGetHPCCNAME(byte[] pBuffer, ref int iBufferLen);
        // 4.8 取得醫事人員卡英文姓名
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hpcGetHPCENAME")]
        public static extern int hpcGetHPCENAME(byte[] pBuffer, ref int iBufferLen);
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetICD10EnC")]
        //5.1 進行疾病診斷碼押碼
        public static extern int hisGetICD10EnC(byte[] pIN, byte[] pOUT);
        [DllImport("C:\\Windows\\SysWOW64\\CSHIS.dll",EntryPoint = "hisGetICD10DeC")]
        //5.2 進行疾病診斷碼解押碼
